...
local function downloadFile(path, func)
	if not isfile(path) then
		...
		local suc, res = pcall(function()
			return game:HttpGet('https://raw.githubusercontent.com/7GrandDadPGN/VapeV4ForRoblox/a1a647c8475611d0acfd2068bf8f6a0453ae7615/'..select(1, path:gsub('newvape/', '')), true) -- https://api.github.com/repos/7GrandDadPGN/VapeV4ForRoblox/commits/main
		end)
